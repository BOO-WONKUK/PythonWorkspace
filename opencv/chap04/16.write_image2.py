...
image8 = cv2.imread("opencv/chap04/images/read_color.jpg", cv2.IMREAD_COLOR)
...
cv2.imwrite("opencv/chap04/images/write_test_16.tif", image16)
cv2.imwrite("opencv/chap04/images/write_test_32.tif", image32)
